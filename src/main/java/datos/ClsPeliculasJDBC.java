...
public class ClsPeliculasJDBC {
   private static final String SQL_SELECT = "SELECT * FROM tb_peli";
    private static final String SQL_INSERT ="insert into tb_peli (nombre, año) values(?,?)";//? = parametros
    private static final String SQL_UPDATE = "update tb_peli set nombre=?, año=? where nombre=?";
    private static final String SQL_DELETE = "delete from tb_peli where nombre=?";
